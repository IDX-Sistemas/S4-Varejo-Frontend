sap.ui.define([
	...
	return {
		...
		handleValueHelp: function(oView, sId) {
			...
			Fragment.load({
				id: oView.getId(),
				name: "br.com.idxtec.commons.helpers.Cartao2HelpDialog",
				controller: this
		...
		_handleValueHelpSearch : function (evt) {
			...
			var oFilterNome = new Filter("Descricao", FilterOperator.StartsWith, sValue)
		...
		_handleValueHelpClose : function (evt) {
			...
			if (oContext) {
				...
				oInput.setSelectedKey( oContext.getProperty("RowId") );
			}

...
function(BaseController, MessageBox, ErrorHandler, Lojas2HelpDialog) {
  "use strict";

  return BaseController.extend("ContaBancaria.controller.FormEdit", {
    ...
    _routerMatch: function(oEvent){
      ...
      oView.bindElement(`/ContaBancaria(${id})`); 
    },

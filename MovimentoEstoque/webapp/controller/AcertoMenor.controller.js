...
function(BaseController, MessageBox, ErrorHanlder, Filter, FilterOperator, Lojas2HelpDialog, ProdutoHelpDialog) {
  ...
  return BaseController.extend("MovimentoEstoque.controller.AcertoMenor", {
    ...
    onInit: function (){
      ...
      oRouter.getRoute("AcertoMenor").attachMatched( this._routerMatch , this );
    ...
    _routerMatch: function(oEvent){
    	...
    	oContext.setProperty("CodigoTransferencia", "03");
    	oContext.setProperty("LocalEstoqueEntrada", "00");

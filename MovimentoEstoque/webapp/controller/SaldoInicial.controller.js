...
function(BaseController, MessageBox, ErrorHanlder, Filter, FilterOperator, 
		  Lojas2HelpDialog, ProdutoHelpDialog) {
  "use strict";

  return BaseController.extend("MovimentoEstoque.controller.SaldoInicial", {
    ...
    onInit: function (){
      ...
      oRouter.getRoute("SaldoInicial").attachMatched( this._routerMatch , this );
    ...
    _routerMatch: function(oEvent){
    	...
    	oContext.setProperty("CodigoTransferencia", "01");
    	oContext.setProperty("LocalEstoqueSaida", "00");
    	oContext.setProperty("QuantidadeAtual", 1);

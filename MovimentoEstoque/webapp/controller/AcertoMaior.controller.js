...
function(BaseController, MessageBox, ErrorHanlder, Filter, FilterOperator, 
  ...
  return BaseController.extend("MovimentoEstoque.controller.AcertoMaior", {
    ...
    onInit: function (){
      ...
      oRouter.getRoute("AcertoMaior").attachMatched( this._routerMatch , this );
    ...
    _routerMatch: function(oEvent){
    	...
    	oContext.setProperty("CodigoTransferencia", "02");

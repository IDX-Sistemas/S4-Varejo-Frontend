...
function(BaseController, MessageBox, ErrorHanlder) {
  ...
  return BaseController.extend("Fornecedores.controller.FormAdd", {
    ...
    _routerMatch: function(oEvent){
    	...
    	var oBinding = oModel.bindList("/Fornecedores");
    	...
    	var oFunction = oModel.bindContext("/GetProximoCodigoFornecedor(...)");

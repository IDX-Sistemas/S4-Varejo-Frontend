...
function(BaseController, MessageBox, ErrorHanlder, Filter, FilterOperator, Lojas2HelpDialog, Cliente2HelpDialog) {
  "use strict";

  return BaseController.extend("Cheques.controller.FormAdd", {
    ...
    _routerMatch: function(oEvent){
    	...
    	var oBinding = oModel.bindList("/Cheques");
